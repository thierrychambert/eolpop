...
# Initial stuff
{
  ...
  species_list <- c(species_list, "Custom species")
              ...
              {selectInput(inputId = "species_choice",
                           ...
                           label = h4(strong("Select a species"),
                                      ...
                                      bsPopover(id = "Q_species_choice",
                                                ...
                                                content = HTML(
                                                  "Required to populate <b>vital rate</b> values (survivals, fecundities). <br><br> The species provided here correspond to the priority list of the MAPE project. If needed, an option \\'Custom species\\' is available at the end of the list."
                                                ),
                                                placement = "right",
                                                trigger = "click",
                                                options = list(container='body')
